...
import 'package:maisound/ui/timeline.dart';
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          color: const Color(
                              0xFF1D1D26), // Background color for the sidebar
                          child: InstrumentSidebar(),
                        ),

                        // Right content area with instruments and their timelines
                        Expanded(
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            children: [
                              Expanded(
                                child: ListView.builder(
                                  itemCount: _soundContainers
                                      .length, // Assuming you have a list of instruments
                                  itemBuilder: (context, index) {
                                    final instrument =
                                        Instrument(); //_soundContainers[index];
                                    return Row(
                                      children: [
                                        // Timeline corresponding to the instrument on the right
                                        Expanded(
